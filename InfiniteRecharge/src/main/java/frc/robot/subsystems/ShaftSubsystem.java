...
public class ShaftSubsystem extends SubsystemBase {
  ...
  public ShaftSubsystem(DigitalInput bb1, DigitalInput bb2, DigitalInput bb3, CANSparkMax motor, Joystick operator,
    ...
    barrelLayout = driverTab.getLayout("Barrel", BuiltInLayouts.kList).withPosition(ControlConstants.barrelColumn, 1)
        .withSize(1, 4);
  ...
  public void setShaftState(ShaftState newState) {
    state = newState;
  }
